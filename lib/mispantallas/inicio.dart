...
// --- PANTALLA 1: HELADOS ---
class HeladosScreen extends StatelessWidget {
  const HeladosScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: HeaderSuperior(routeName: "/"),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text("Presentando Helados", style: TextStyle(fontSize: 18, color: Colors.grey)),
            const Text("Por tiempo limitado", style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
            const SizedBox(height: 30),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: const [
                ItemMenu(
                  title: "Hecho con KitKat en trozos", 
                  imageUrl: "https://raw.githubusercontent.com/OmarMartinez0637/Imagenes-Para-DairyQueen/refs/heads/main/kitkat.PNG",
                ),
                ItemMenu(
                  title: "Hecho con KitKat y Caramelo", 
                  imageUrl: "https://raw.githubusercontent.com/OmarMartinez0637/Imagenes-Para-DairyQueen/refs/heads/main/kitkatcaramelo.PNG",
                ),
              ],
            ),
            const SizedBox(height: 30),
            const ItemMenu(
              title: "Hecho con KitKat y Fresa", 
              imageUrl: "https://raw.githubusercontent.com/OmarMartinez0637/Imagenes-Para-DairyQueen/refs/heads/main/kitkatfresa.PNG",
            ),
          ],
        ),
      ),
