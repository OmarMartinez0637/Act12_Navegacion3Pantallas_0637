...
class PastelesScreen extends StatelessWidget {
  const PastelesScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const HeaderSuperior(routeName: "/pasteles"),
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            const Align(
              ...
              child: ItemMenu(title: "Pastel Blizzard Fresa KitKat", imageUrl: "https://raw.githubusercontent.com/OmarMartinez0637/Imagenes-Para-DairyQueen/refs/heads/main/pastel1.PNG"),
            ),
            const Divider(height: 60),
            const Text("Pasteles de Helado", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
            const SizedBox(height: 20),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: const [
                ItemMenu(title: "Pastel Chocolate", imageUrl: "https://raw.githubusercontent.com/OmarMartinez0637/Imagenes-Para-DairyQueen/refs/heads/main/pastel2.PNG"),
                ItemMenu(title: "Pastel Fresa", imageUrl: "https://raw.githubusercontent.com/OmarMartinez0637/Imagenes-Para-DairyQueen/refs/heads/main/pastel3.PNG"),
              ],
            ),
          ],
        ),
